...
import core.pg.entities
import core.pg.select
import core.pg.expressions
api.login = login
core.pg.select.api = api
core.pg.expressions.inject_api(api)
...
def indexview():
    ...
    with open('./core/index/index.html','r') as ifile:
        return ifile.read()
...
@app.route('/tables/<objid>/tile/<x>/<y>/<z>/tile.geo.json',methods=['GET'])
@app.route('/Table/<objid>/tile/<x>/<y>/<z>/tile.geo.json',methods=['GET'])
...
@app.route('/tables/<objid>/tile/<x>/<y>/<z>/<magnitude>/tile.geo.json',methods=['GET'])
@app.route('/Table/<objid>/tile/<x>/<y>/<z>/<magnitude>/tile.geo.json',methods=['GET'])
...
@app.route('/views/<objid>/tile/<x>/<y>/<z>/tile.geo.json',methods=['GET'])
@app.route('/View/<objid>/tile/<x>/<y>/<z>/tile.geo.json',methods=['GET'])
...
@app.route('/views/<objid>/tile/<x>/<y>/<z>/<magnitude>/tile.geo.json',methods=['GET'])
@app.route('/View/<objid>/tile/<x>/<y>/<z>/<magnitude>/tile.geo.json',methods=['GET'])
